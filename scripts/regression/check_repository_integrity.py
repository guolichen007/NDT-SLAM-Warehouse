...
def stationary_motion_contract_failures() -> list[str]:
    ...
    required = (
        ...
        "evaluateLocalMapUpdate",
        "normal_motion_update_allowed",
        "motion_escape_refresh_allowed",
...
def registration_source_contract_failures() -> list[str]:
    ...
    paths = (
        ...
        Path("src/ndt_slam/src/ndt_slam.cpp"),
        Path("src/ndt_slam/src/cargo_alarm_heartbeat_node.cpp"),
...
def static_evidence_contract_failures() -> list[str]:
    ...
    paths = (
        ...
        Path("src/ndt_slam/src/cargo_motion_corridor.cpp"),
        Path("src/ndt_slam/src/static_height_field.cpp"),
        Path("src/ndt_slam/src/ndt_slam.cpp"),
        Path("src/ndt_slam/src/runtime_diagnostics.cpp"),
        Path("src/ndt_slam/config/live_longterm_mapping.yaml"),
    ...
    required = (
        ...
        "directional_filter_enabled",
        "pointcloud_sanity",
        "pointcloud_z_outlier_rejected",
        "kNdtTimingEmaAlpha",
